...
SNAPSHOT_LAST_LINES = 15000 # DEFAULT_SNAPSHOT_LAST_LINES # Arbeitsparameter, wird variabel auf Periode angepasst, niedriger Startwert = schneller Start
ESTIMATED_PERIOD_MINUTES = 60  # gewünschte Dauer des analysierten Zeitraums je Lauf, z.B. 150 Minuten (= 2.5h)
...
PARAM_SPECS = {
    ...
    "TAKE_PROFIT_PCT":                      (0.0060, 0.0010, 0.0005, 0.0010, 0.100),      # (0.0060, 0.0010, 0.0010, 0.0010, 0.1),
    "BREAK_EVEN_STOP_PCT":                  (0.0045, 0.0010, 0.0005, 0.0000, 0.100),     # (0.0045, 0.0010, 0.0010, 0.0010, 0.01),
